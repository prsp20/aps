...
public class UserAccountMapperTest {
    ...
    void userSignupPayloadToUserAccountEntity_should_convert_userSignupPayloadToUserAccountEntity(){
        UserAccountEntity mappedUserAccountEntity = userAccountMapper
                .userSignupPayloadToUserAccountEntity(userSignupPayload);

        Assertions.assertThat(mappedUserAccountEntity).isNotNull();
        Assertions.assertThat(mappedUserAccountEntity.getFirstName()).isEqualTo(userSignupPayload.getFirstName());
        Assertions.assertThat(mappedUserAccountEntity.getLastName()).isEqualTo(userSignupPayload.getLastName());
        Assertions.assertThat(mappedUserAccountEntity.getEmail()).isEqualTo(userSignupPayload.getEmail());
    }
    ...
    void userSignUpPayloadToUserAccountEntity_should_generate_unique_uuid(){
        ...
        UserAccountEntity secondMappedUserAccountEntity = userAccountMapper
                .userSignupPayloadToUserAccountEntity(userSignupPayload);
