...
* The original package name 'com.prakass.aps' is invalid and this project uses 'com.prakass.aps' instead.
...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/3.4.1-SNAPSHOT/reference/packaging/native-image/introducing-graalvm-native-images.html)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/3.4.1-SNAPSHOT/how-to/aot.html)
...
```
$ docker run --rm -p 8080:8080 aps-service:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/aps-service
```
